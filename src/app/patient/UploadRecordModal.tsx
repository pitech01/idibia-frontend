    ...
    return (
        <div style={{
            ...
            <div className="animate-fade-in" style={{
                ...
                {/* Header */}
                <div style={{ padding: isMobile ? '24px' : '32px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: isMobile ? '1px solid #f1f5f9' : 'none' }}>
                    <h2 style={{ fontSize: isMobile ? '20px' : '24px', fontWeight: '900', color: '#1e293b', margin: 0 }}>Digitize Record</h2>
                    <button onClick={onClose} style={{ background: '#f8fafc', border: 'none', borderRadius: '50%', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: '#64748b' }}>
                        <Icons.X />
                    </button>
                </div>

                <div style={{ padding: isMobile ? '24px' : '0 40px 40px 40px', overflowY: 'auto' }}>
                    ...
                    <div
                        ...
                        onDrop={handleDrop}
                        style={{
                            border: `2px dashed ${dragActive ? '#2E37A4' : '#e2e8f0'}`,
                    ...
                    {/* Footer Actions */}
                    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'flex-end', gap: '12px', marginTop: '32px', paddingTop: '16px' }}>
                        <button onClick={onClose} style={{ padding: '12px 24px', borderRadius: '12px', background: 'none', border: 'none', color: '#64748b', fontWeight: '700', cursor: 'pointer', order: isMobile ? 2 : 1 }}>Cancel</button>
                        <button style={{ padding: '14px 28px', borderRadius: '14px', background: '#2E37A4', color: 'white', border: 'none', fontWeight: '800', cursor: 'pointer', boxShadow: '0 10px 15px -3px rgba(46, 55, 164, 0.2)', order: isMobile ? 1 : 2 }}>Upload & Process</button>
                    </div>
